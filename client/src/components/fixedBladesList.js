...
function FixedBlades() {
  ...
  const fixedBladesTrue = knives.filter(i => i.fixedBlades === true);
  const renderFixedBlades = fixedBladesTrue.map((i) =>
  ...
  return (
    <div className='dashboard'>
      ...
      <div className='column1'>
        ...
        <h3 className='dashboardTitle3'>FixedBlades</h3>
      </div>
