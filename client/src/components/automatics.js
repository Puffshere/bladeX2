...
function Automatics() {
  ...
  const automaticsTrue = knives.filter(i => i.automatics === true);
  ...
  return (
    <div className='dashboard'>
      ...
      <div className='column1'>
        ...
        <h3 className='dashboardTitle3'>Automatics</h3>
      </div>
      <Table className='tableStyling' />
      <center><h2 className='allKnivesStyling'>Automatics:</h2></center>
      <br></br>
